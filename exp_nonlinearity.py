...
layers1.append(DenseLayer(layers1[-1],K=64,R=2,nonlinearity=nonlinearity,sparsity_prior=0.,sigma=sigmass,learn_pi=1,p_drop=0.))
layers1.append(DenseLayer(layers1[-1],K=32,R=2,nonlinearity=nonlinearity,sparsity_prior=0.,sigma=sigmass,learn_pi=1,p_drop=0.))
