...
if(1):
    layers1 = [InputLayer(input_shape,X=XX)]
    layers1.append(CategoricalLastLayer(layers1[-1],R=20))
elif(MODEL==1):
...
LOSSES  = model1.train(0.01,alpha_schedule=schedule(0.0000,'sqrt'),CPT=200,random=0,fineloss=0,verbose=0,per_layer=1,mp_opt=0)
