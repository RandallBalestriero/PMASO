...
layers1.append(DenseLayer(layers1[-1],K=64,R=2,nonlinearity=None,sparsity_prior=0.,sigma='local',learn_pi=1,p_drop=0.,bn=BN(0,0),U=0))
layers1.append(DenseLayer(layers1[-1],K=64,R=2,nonlinearity=None,sparsity_prior=0.,sigma=sigmass,learn_pi=1,p_drop=0.,bn=BN(0,0),U=0))
...
LOSSES  = train_layer_model(model1,rcoeff_schedule=schedule(0.0000000001,'sqrt'),CPT=200,random=0,fineloss=0,verbose=0)
