...
layers1.append(DenseLayer(layers1[-1],K=32*nonlinearity,R=2,nonlinearity=None,sparsity_prior=0.,sigma=sigmass,learn_pi=1,p_drop=0.))
#layers1.append(DenseLayer(layers1[-1],K=16*nonlinearity,R=2,nonlinearity=None,sparsity_prior=0.,sigma=sigmass,learn_pi=1,p_drop=0.))
...
f=open('/mnt/project2/rb42Data/PMASO/BASE_EXP/exp_neurons_'+str(nonlinearity)+'.pkl','wb')
