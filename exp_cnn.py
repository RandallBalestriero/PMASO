...
layers1.append(ConvPoolLayer(layers1[-1],Ic=5,Jc=5,Ir=2,Jr=2,K=n_filters,R=2,nonlinearity=None,sparsity_prior=0.0,sigma=sigmass))
...
layers1.append(DenseLayer(layers1[-1],K=32,R=2,nonlinearity=None,sparsity_prior=0.,sigma='local',learn_pi=1,p_drop=0.,bn=BN(0,0),U=0))
